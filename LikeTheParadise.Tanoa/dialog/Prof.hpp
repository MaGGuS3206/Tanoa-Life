/*File: prof.hppAuthor: Jacob "PapaBear" Tyler Description:Dialog for new gui*/
class Life_Prof_Dialog{idd = 7730;
	...
	class controlsBackground {
		class Frame: Life_RscText{
			...
			idc = -1;x = 10.5 * GUI_GRID_W + GUI_GRID_X;
		...
		class controls {
			class Prof_Text: Life_RscStructuredText{
				...
				w = 5 * GUI_GRID_W;h = 13.5 * GUI_GRID_H;
			};
			class Prof2_Text: Life_RscStructuredText{
				idc = 7732;
				x = 16 * GUI_GRID_W + GUI_GRID_X;
				y = 4 * GUI_GRID_H + GUI_GRID_Y;
				w = 4 * GUI_GRID_W;h = 13.5 * GUI_GRID_H;
			};
			class Prof3_Text: Life_RscStructuredText{
				idc = 7733;
				x = 20 * GUI_GRID_W + GUI_GRID_X;
				y = 4 * GUI_GRID_H + GUI_GRID_Y;
				w = 7 * GUI_GRID_W;h = 13.5 * GUI_GRID_H;
			};
