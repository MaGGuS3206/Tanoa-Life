...
while {true} do 
 ...
 <img size='1.6' shadowColor='#000000' image='icons\Statusbar\players.paa' color='#CC0000'/>%3 
 <img size='1.6' shadowColor='#000000' image='icons\Statusbar\ico_map.paa'/>%4
 ...
 <img size='1.6' shadowColor='#000000' image='icons\Statusbar\monitor_fps.paa' color='%14'/>%13
 <img size='1.6' shadowColor='#000000' image='icons\Statusbar\restart.paa' color='%16'/>%15
 </t>",_CivplayHUD,_WestplayHUD,_IndepplayHUD, format["%1/%2",_xx,_yy], 
 _hunger, 
 _colourHunger, 
 _thirst, 
 _colourThirst, 
