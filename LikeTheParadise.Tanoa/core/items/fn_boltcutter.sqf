...
// if ((typeOf _building) == "Land_Offices_01_V1_F" && (nearestObject [[13285.831,11992.301,0.4],"Land_Offices_01_V1_F"]) getVariable ["locked",true]) exitWith {hint localize "STR_ISTR_Bolt_Exploit"}; // auskommentiert
...
if ((nearestObject [[13285.831,11992.301,0.4],"Land_Offices_01_V1_F"]) == _building) then {
