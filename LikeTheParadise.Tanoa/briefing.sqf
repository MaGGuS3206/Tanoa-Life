...
This section is meant for people doing their own edits to the mission, DO NOT REMOVE THE ABOVE.<br/><br/>
        ...
        [
            "Regelwerk",
                "
Um unser Regelwerk zu sehen, besuche bitte www.like-the-paradise.net<br/><br/>
...
U: Fahrzeug auf- und zuschliessen.<br/>
T: Virtuelles Autoinventar oeffnen.<br/>
Linkes Shift + B: Ergeben.<br/>
Linke Windowstaste: Hauptinteraktionstaste zum Farmen oder Interagieren (ATM).<br/>
Linkes Shift + H: Waffe schultern.<br/>
Shift + Leertaste: Springen.<br/>
Linkes Shift + O: Sound leiser oder lauter.<br/><br/>
                "
        ]
    ];
