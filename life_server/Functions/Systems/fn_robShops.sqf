...
{
[1,"This station was robbed recently, no money here!"] remoteExec ["life_fnc_broadcast",_robber2];
...
[_shop,_robber,_action] remoteExec ["life_fnc_robShops2",_robber2]; //we have now done all the checks and it is time to start the robbery script locally for the robber.
